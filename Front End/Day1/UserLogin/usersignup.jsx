    ...
    <div className="l-form">
      ...
      <div className="form">
        ...
        <form action="" className="form__content">
          <h1 className="form__title">User Signup</h1>
          ...
          <Link to = '/userlog'><input type="submit" className="form__button" value="Sign up" /></Link>

          <div className="form__social">
          <Link to='/userlog'><span className="form__social-text">Have an account ?sign in </span></Link>
