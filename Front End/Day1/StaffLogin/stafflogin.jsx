...
import './stafflogin.css'; // Import your CSS file
    ...
    <div className="l-form">
      ...
      <div className="form">
        ...
        <form action="" className="form__content">
          <h1 className="form__title">Staff Login</h1>
          ...
          <Link to = '/staffside'><input type="submit" className="form__button" value="Login" /></Link>

          <div className="form__social">
          <Link to='/stafflog'><span className="form__social-text">Don't have account ? </span></Link>
